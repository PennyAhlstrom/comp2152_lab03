...
# TODO: Use list() and range() to create a list of dice values ([1, 2, 3, 4, 5, 6]) instead of the current hard-coded values
#diceOptions = [1, 2, 3, 4, 5, 6]
diceOptions = list(range(1, 7))
print(diceOptions)

#diceRange = range(1, 7) # 7 does not get included
...
i = 1
for w in weapons: #This is like a foreach loop in other languages
#    print(i, w)
#    print(i, ".", w) - will give extra space after the index number like 1 . Knife
    print(f"{i}. {w}")
    i += 1
...
mCombatStrength = input("Enter the Monsters combat Strength: (Number between 1-6) ")
